...
[[nodiscard]] auto sumElements(const std::vector<int>& vector, const int numElements)
{
    int sum {};
...
int func1()
{
    std::string filename{"/Users/juliettekouidri/Documents/Reuben/Projects/Cpp/AoC22/day1_data.txt"};
    std::ifstream file {};
    ...
    // top 3 elves carrying the most amount of munch
